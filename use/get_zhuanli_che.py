...
def get_comp(connect):
	...
	"""
	cur = connect.cursor()
	# select count(id) from zhuanli_shenqing_comp where comp_full_name in (select comp_full_name from zhuanli_xiongan_comp where change_gai != '删除')
